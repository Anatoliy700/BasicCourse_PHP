...
gulp.task('prod', gulp.series('del', gulp.parallel('publish-components', 'image', 'html', 'php', 'sass', 'scripts', 'json')));


gulp.task('default', gulp.series('del', gulp.parallel('publish-components', 'image', 'html', 'php', 'sass', 'scripts', 'json'), gulp.parallel('watchFile', 'server')));
